...
export const footerSections = [
  {
    title: 'Solutions',
    links: [
      { name: 'Marketing', href: '/marketplace' },
      { name: 'Analytics', href: '/product/analytics' },
      { name: 'Automation', href: '/product/automations' },
      { name: 'Commerce', href: '/marketplace/commerce' },
  ...
  },
  {
    title: 'Support',
    links: [
      { name: 'Submit ticket', href: '/faq/submit-ticket' },
...
export const logos = [
  ...
  },
  {
    ...
    alt: 'SavvyCal',
    classes: 'col-span-2 max-h-12 w-full object-contain sm:col-start-2 lg:col-span-1'
  },
  {
    src: 'https://tailwindui.com/plus/img/logos/158x48/statamic-logo-gray-900.svg',
    alt: 'Statamic',
    classes: 'col-span-2 col-start-2 max-h-12 w-full object-contain sm:col-start-auto lg:col-span-1'
  }
]
